...
class ReportController extends Controller
{
    ...
    public function estudiantesInscritosPDF()
    {
        ...
        $students = Student::with(['courses.commissions'])->get();
        $pdf = Pdf::loadView('reports.pdf.estudiantes-inscritos-pdf', compact('students'));
    ...
    {
        $subjects = Subject::with('courses')->get();
        $pdf = Pdf::loadView('reports.pdf.cursos-por-materia-pdf', compact('subjects'));
    ...
    {
        $commissions = Commission::with(['course.subject', 'professor'])->get();
        $pdf = Pdf::loadView('reports.pdf.comisiones-y-horarios-pdf', compact('commissions'));
    ...
    {
        $professors = Professor::with('commissions.course')->get();
        $pdf = Pdf::loadView('reports.pdf.asistencia-profesores-pdf', compact('professors'));
